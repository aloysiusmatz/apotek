                                ...
                                <tr class="border-b border-gray-200 hover:bg-gray-100" ">
                                    ...
                                    <td class="py-2 px-6 text-center">
                                        <div class="flex item-center justify-center">
                                            ...
                                            <div onclick="return confirm('Are you sure want to delete this data? This action also remove Role VS Permission records related, please condider!') || event.stopImmediatePropagation()" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110 cursor-pointer"  wire:click="deleteDataRow({{$data->id}})" >
