...
class UserRoleTable extends Component
{
    ...
    public function render()
    {
        if ($this->show_data_id == 0) {
            return <<<'blade'
            <div>
                select a user to show its roles and permissions
            </div>
            blade;
        }

        $query = "select a.*, b.name as role_name from model_has_roles a, roles b ";
        $sort_query = "";
        ...
        if ($this->search_data == "") {
            $query .= "where a.model_type like '%User' and model_id='".$this->show_data_id."' and a.role_id=b.id " ;
        ...
        return <<<'blade'
            <div class="bg-white shadow-md rounded-md overflow-hidden">
                <div class="ml-2 mt-2">
                    ...
                    <p class="text-md font-bold"> User's Roles</p>
                                    ...
                                    <tr class="border-b border-gray-200 hover:bg-gray-100" ">
                                        ...
                                        <td class="py-2 px-6 text-center">
                                            <div class="flex item-center justify-center">
                                                <div onclick="return confirm('Are you sure want to delete this data?') || event.stopImmediatePropagation()" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110"  wire:click="deleteDataRow({{$data->role_id}})" >
