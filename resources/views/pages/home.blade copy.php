...
<head>
    ...
    <!-- Custom CSS -->
    <link href="/matrix/assets/libs/flot/css/float-chart.css" rel="stylesheet">
    <!-- Custom CSS -->
...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <header class="topbar" data-navbarbg="skin5">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header pl-7 text-white font-medium font-size" data-logobg="skin5">
                    
                    <h1 href="#" class="">Apotek</h1>
                    ...
                    <ul class="navbar-nav float-end">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="/matrix/assets/images/users/1.jpg" alt="user" class="rounded-circle" width="31">
                            </a>
                    ...
                    <ul id="sidebarnav" class="pt-4">
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="index.html" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span
                                    class="hide-menu">Items</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                        ...
                        <div class="card">
                            ...
                            <div class="comment-widgets scrollable">
                                ...
                                <div class="d-flex flex-row comment-row mt-0">
                                    <div class="p-2"><img src="/matrix/assets/images/users/1.jpg" alt="user" width="50"
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><img src="/matrix/assets/images/users/4.jpg" alt="user" width="50"
                                            class="rounded-circle"></div>
                                ...
                                <!-- Comment Row -->
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><img src="/matrix/assets/images/users/5.jpg" alt="user" width="50"
                                            class="rounded-circle"></div>
                                    <div class="comment-text w-100">
                                        ...
                                        <li class="list-group-item todo-item" data-role="task">
                                            ...
                                            <ul class="list-style-none assignedto">
                                                <li class="assignee"><img class="rounded-circle" width="40"
                                                        src="/matrix/assets/images/users/1.jpg" alt="user"
                                                        data-toggle="tooltip" data-placement="top" title=""
                                                        data-original-title="Steave"></li>
                                                <li class="assignee"><img class="rounded-circle" width="40"
                                                        src="/matrix/assets/images/users/2.jpg" alt="user"
                                                        data-toggle="tooltip" data-placement="top" title=""
                                                        data-original-title="Jessica"></li>
                                                <li class="assignee"><img class="rounded-circle" width="40"
                                                        src="/matrix/assets/images/users/3.jpg" alt="user"
                                                        data-toggle="tooltip" data-placement="top" title=""
                                                        data-original-title="Priyanka"></li>
                                                <li class="assignee"><img class="rounded-circle" width="40"
                                                        src="/matrix/assets/images/users/4.jpg" alt="user"
                                                        data-toggle="tooltip" data-placement="top" title=""
                            ...
                            <div class="card-body">
                                ...
                                <div class="chat-box scrollable" style="height:475px;">
                                    ...
                                    <ul class="chat-list">
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="/matrix/assets/images/users/1.jpg" alt="user">
                                            </div>
                                        ...
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="/matrix/assets/images/users/2.jpg" alt="user">
                                            </div>
                                            <div class="chat-content">
                                        ...
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="/matrix/assets/images/users/3.jpg" alt="user">
                                            </div>
                                            <div class="chat-content">
                                ...
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        <p>And is full of waffle to It has multiple paragraphs and is full of waffle to
                                            ...
                                            comment..</p>
                                        <img src="/matrix/assets/images/background/img4.jpg" class="img-fluid">
                                    </div>
                                </div>
    ...
    <script src="/matrix/assets/libs/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
